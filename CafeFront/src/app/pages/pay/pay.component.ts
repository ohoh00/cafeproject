...
export class PayComponent implements OnInit  {
  ...
  constructor(private os: OrderService,private cs: CustomerService,private ls : LocalStorageService,private pr : PromotionService,private sanitizer: DomSanitizer,private py: PaytypeService) {
